        ...
        <main role="main" class="main-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h1 class="page-title text-center my-4">Laporan Harian</h1>

                        <div class="card shadow-lg border-0">
                            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                                <span><strong>Tanggal:</strong> {{ $date }}</span>
                                <form method="GET" action="{{ route('reports.daily') }}" class="form-inline">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-4">
                                    <div>
                                        <a href="{{ route('reports.daily.csv', ['date' => $date]) }}" class="btn btn-success mr-2">Unduh CSV</a>
                                        <a href="{{ route('reports.daily.pdf', ['date' => $date]) }}" class="btn btn-danger">Unduh PDF</a>
                                    </div>
